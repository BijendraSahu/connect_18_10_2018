/*! EmojioneArea v3.2.7 | MIT license */
window = "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, document = window.document || {},
    function(a, b) {
        ...
        var r = window.emojioneVersion || "2.2.7";
        ...
        function L(b, c, d) {
            ...
            var g = c.is("TEXTAREA") || c.is("INPUT") ? "val" : "text",
                ...
                }), M = G("scroll-area", A = G("emojis-list")))).addClass(F("picker-position-" + d.pickerPosition, !0)).addClass(F("filters-position-" + d.filtersPosition, !0)).addClass("hidden"));
            if (b.searchSel = null, i.data(c.data()), a.each(d.attributes, function(a, b) {
                    i.attr(a, b)
                }), G("category").attr({
                    "data-tone": 0
                }).appendTo(A), a.each(d.filters, function(c, e) {
                    var f = 0;
                    if ("recent" !== c || b.recentEmojis) {
                        ...
                        do {
                            ...
                            0 === f ? (g = A.children('[data-tone="0"]'), h["data-sub-category"] = !0) : g = A;
                            var i = G("category").attr(h).appendTo(g),
                                j = e.emoji.replace(/[\s,;]+/g, "|");
                            f > 0 && (i.hide(), j = j.split("|").join("_tone" + f + "|") + "_tone" + f), "recent" === c && (j = H()), j = p(j, b.sprite ? '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><i class="emojione-{uni}"></i></i>' : '<i class="emojibtn" role="button" data-name="{name}" title="{friendlyName}"><img class="emojioneemoji lazy-emoji" data-src="{img}"/></i>', !0).split("|").join(""), i.html(j), a('<div class="emojionearea-category-title"/>').text(e.title).prependTo(i)
                        } while (--f > 0)
                    }
                }), d.filters = null, b.sprite || (b.lasyEmoji = A.find(".lazy-emoji")), v = u.find(F("filter")), v.eq(0).addClass("active"), L = A.find(F("category")), b.recentFilter = v.filter('[data-filter="recent"]'), b.recentCategory = L.filter("[name=recent]"), b.scrollArea = M, d.container ? a(d.container).wrapInner(N) : N.insertAfter(c), d.hideSource && c.hide(), b.setText(c[g]()), c[g](b.getText()), D.apply(b), b.standalone && !b.getText().length) {
                var O = a(c).data("emoji-placeholder") || d.emojiPlaceholder;
                b.setText(O), i.addClass("has-placeholder")
            }
            n(b, A.find(".emojibtn"), {
            ...
            if (M.on("scroll", function() {
                    if (!P && (E.call(b), M.is(":not(.skinnable)"))) {
                        var c = L.eq(0),
                            d = M.offset().top;
                        L.each(function(b, e) {
                    ...
                    P = !0, c || (v.filter(".active").removeClass("active"), a.addClass("active"));
                    ...
                    c ? (M.addClass("skinnable"), L.filter(":not([data-sub-category])").hide().filter("[data-tone=" + c + "]").show(), v.eq(0).is('.active[data-filter="recent"]') && v.eq(0).removeClass("active").next().addClass("active")) : (M.removeClass("skinnable"), L.filter(":not([data-sub-category])").hide().filter("[data-tone=0]").show(), v.eq(0).click()), E.call(b), d.search && b.trigger("search.keypress")
                    ...
                    return a(d.target).hasClass("search") ? (b.stayFocused = !0, null === b.searchSel && (b.searchSel = x(c[0]))) : (N.is(".focused") || c.focus(), d.preventDefault()), !1
                }).on("@change", function() {
                    ...
                    g && g.length ? (b.recentFilter.hasClass("active") && b.recentFilter.removeClass("active").next().addClass("active"), b.recentCategory.hide(), b.recentFilter.hide(), L.filter(":not([data-sub-category])").each(function() {
                            var b = function(a, b) {
                                ...
                                c = a(this);
                            b(c, f), 0 === c.data("tone") && c.children(F("category") + ':not([name="recent"])').each(function() {
                                b(a(this), 0)
                            })
                        }), P ? E.call(b) : M.trigger("scroll")) : (I(b, !0), L.filter('[data-tone="' + t.find("i.active").data("skin") + '"]:not([name="recent"])').show(), a(".emojibtn", L).show(), e.show(), c || E.call(b))
            ...
            b.inline && (N.addClass(F("inline", !0)), b.on("@keydown", function(a, b) {
        ...
        function N(b) {
            if (b = w(b), !M.isLoading)
                if (!e || u(t(e)) < 2) {
                    M.isLoading = !0;
                    var c;
                    c = u(r) > 5 ? M.defaultBase3 + "npm/emojione@" + r : u(r) > 4 ? M.defaultBase3 + "emojione/" + r : M.defaultBase + "/" + r, a.ajax({
                        url: c + "/lib/js/emojione.min.js",
                        dataType: "script",
                        cache: !0,
                        success: function() {
                            e = window.emojione, r = t(e), k = u(r);
                            var c;
                            k > 4 ? (M.base = M.defaultBase3 + "emojione/assets/" + r, c = M.base + "/sprites/emojione-sprite-" + e.emojiSize + ".css") : (M.base = M.defaultBase + r + "/assets", c = M.base + "/sprites/emojione.sprites.css"), b.sprite && (document.createStyleSheet ? document.createStyleSheet(c) : a("<link/>", {
                                    rel: "stylesheet",
                                    href: c
                                }).appendTo("head"));
                ...
                } else r = t(e), k = u(r), k > 4 ? M.base = M.defaultBase3 + "emojione/assets/" + r : M.base = M.defaultBase + r + "/assets";
            g(function() {
                var a = "";
