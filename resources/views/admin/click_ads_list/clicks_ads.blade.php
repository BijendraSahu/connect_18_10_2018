            ...
            <div class="advertiselist_block">
                <div class="dash_boxcontainner">
                    <div class="advertise_withhead margin0">
                        <div class="col-sm-6 col-md-4 col-xs-12 head_caption">Clicks Advertise List</div>
                        <div class="btn-group gridbtn-group pull-right" id="TotalRecords"><span
                                    class="grid-counter-text">Counter</span><span
                                    class="btn btn-counter btn-sm">{{count($adsclick)}}</span></div>
                    </div>
                    <div class="panel-body">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody id="">
                            @if(count($adsclick)>0)
                                @foreach($adsclick as $ad)
                                    <tr id="row_{{$ad->id}}">
                                        <td class="tab-grid width_25 col1 display_none" data-line="Advertise Image">
                                            <?php $cat_img = \App\AdsImages::where(['ad_id' => $ad->ad_id])->first(); ?>
                                        ...
                                        <td class="tab-grid width_12 col2"
                                            data-line="Type"
                                            id="admin_adverlist_category">{{isset($ad->ads->ad_cat->category)?$ad->ads->ad_cat->category:'-'}}</td>
                                        ...
                                        <td class="tab-grid width_14 col3" data-line="City"
                                            id="admin_adverlist_city">{{$ad->ads->city}}</td>
