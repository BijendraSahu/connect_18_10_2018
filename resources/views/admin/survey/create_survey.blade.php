...
{!! Form::open(['url' => 'survey', 'class' => 'form-horizontal', 'id'=>'Unit', 'method'=>'post', 'files'=>true]) !!}
<div class="container-fluid">
    ...
    <div class="basic_lb_row">
        ...
        <div class="col-sm-9">
            <input type="text" name="survey_amount" class="form-control amount required" placeholder="Enter Survey Amount" data-validate="Btn_advertise" value="" maxlength="7" autocomplete="off">
        </div>
    </div>
    <div class="basic_lb_row">
        <div class="col-sm-3">
        ...
        <div class="col-sm-9">
            <input type="text" name="no_of_user" class="form-control numberOnly required" placeholder="Enter No of user for this survey" data-validate="Btn_advertise" value="" maxlength="4" autocomplete="off">
        </div>
    </div>
    <div class="basic_lb_row">
        <div class="col-sm-3">
        ...
        <div class="col-sm-9">
            <select name="question_type" id="question_type" onchange="getOptions(this);"
                ...
                <option value="2">2 Options(Yes/No or A/B)</option>
    ...
    <div class="basic_lb_row hidden" id="option3">
        ...
        <div class="col-sm-9">
            <input type="text" name="option3" class="form-control" placeholder="Enter Option 3"
                   data-validate="Btn_advertise" value="" id="txtoption3"
                   maxlength="25" autocomplete="off">
        </div>
    </div>
