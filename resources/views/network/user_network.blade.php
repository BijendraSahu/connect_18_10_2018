            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                    <div class="network_block">
                        ...
                        <div class="level_caption">Level {{$child_level}}</div>
                    ...
                    <form method="post" name="payumoney" target="_blank" id="payu_form_btnblock"
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input type="hidden" name="surl"
                                                       value="http://www.connecting-one.com/PayUkit/response.php"/></td>
                            </tr>
                            <tr>
        ...
        $(document).ready(function () {
            function xn() {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "{{ url('loadSubNetwork') }}",
                    data: '{"a":"' + a + '", "child_id":"' + child_id + '"}',
                    success: function (data) {
                        if (data.t != '') {
                            $('.user_image_containner').append(data.t);
                            $('#hdn_id').val(data.id);
//                            $('#level_id').html(child_level);
                        } else {
